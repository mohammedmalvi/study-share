      ...
      <div onClick={() => navigateTo(`/materials/${material.id}`)} className="bg-white rounded-2xl border border-blue-50 shadow-sm card-hover cursor-pointer overflow-hidden group">
        ...
        <div className="p-5">
          ...
          <div className="flex gap-2">
            <button onClick={handleViewPDF} className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl border border-blue-200 text-blue-700 text-xs font-semibold hover:bg-blue-50 transition-all">
